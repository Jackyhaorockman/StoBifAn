function output = Initial_CME(x_lim_low, d, task, mean, sigma)
% INITIAL_CFPE Returns initial guess vector for solving the CME in
...
switch task
    ...
    case 3 % return an initial guess of delta distributio at the mean value
        ...
        for i = 1 : num_spe
            ...
            % necessary).
            dlt = round((mean(i) - x_lim_low(i,1)) + 1);
